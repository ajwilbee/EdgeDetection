...
%% Kural ve iterasyon sayisini giriniz 
    wsize=3;
     I =double(imread('Im5_grey.jpg'));
     image1 =double(imread('Im5.jpg'));    
     imFullName ='Pep_CA';
     sobel_edge =edge(imread('Im5_grey.jpg'),'sobel',0.08);
     figure(1)
     imshow(sobel_edge)
     canny_edge =edge(imread('Im5_grey.jpg'),'canny',0.1);
     %imshow(I)
